                                        ...
                                        Function_node_Lerp(
                                            Function_node_Lerp(
                                                Function_node_Lerp(
                                                    ...
                                                    float3(0.0431372*node_603, 0.0431372*node_603, 0.5921568*node_603) , 0.0 , 0.01 ) ,

                                                    float3(0.0*node_603, 0.2196078*node_603, 0.7529411*node_603) ,
                                                    float3(0.0196078*node_603, 0.2039215*node_603, 0.7725490*node_603) , 0.0 , 0.01 ) ,

                                                    float3(0.0*node_603, 0.4078431*node_603, 0.9411765*node_603) ,
                                                    float3(0.0156862*node_603, 0.3215686*node_603, 0.8980392*node_603) , 0.0 , 0.01 ) ,

                                                    float3(0.0941176*node_603, 0.5333333*node_603, 0.9411765*node_603) ,
                                                    float3(0.0549019*node_603, 0.4352941*node_603, 0.9254901*node_603) , 0.0 , 0.01 ),

                                                    float3(0.1882352*node_603, 0.6274509*node_603, 0.9411765*node_603) ,
                                                    float3(0.1333333*node_603, 0.5294117*node_603, 0.9450980*node_603) , 0.0 , 0.01 ),

                                                    float3(0.4078431*node_603, 0.8156862*node_603, 0.9411765*node_603) ,
                                                    float3(0.3098039*node_603, 0.6823529*node_603, 0.9529411*node_603) , 0.0 , 0.01 ),
