...
Shader "Custom Palettes/Super Sonic" {
    Properties {
                                        ...
                                        Function_node_Lerp(
                                            Function_node_Lerp(
                                                Function_node_Lerp(
                                                    ...
                                                    float3(0.9411765*node_603, 0.7529412*node_603, 0.003921569*node_603) , 0.0 , 0.01 ) ,

                                                    float3(0.0*node_603, 0.2196078*node_603, 0.7529411*node_603) ,
                                                    float3(0.9411765*node_603, 0.8156863*node_603, 0.1568628*node_603) , 0.0 , 0.01 ) ,

                                                    float3(0.0*node_603, 0.4078431*node_603, 0.9411765*node_603) ,
                                                    float3(0.9411765*node_603, 0.8784314*node_603, 0.2509804*node_603) , 0.0 , 0.01 ) ,

                                                    float3(0.09411764*node_603, 0.5333333*node_603, 0.9411765*node_603) ,
                                                    float3(0.9411765*node_603, 0.9098039*node_603, 0.3764705*node_603) , 0.0 , 0.01 ),

                                                    float3(0.18823529*node_603, 0.6274509*node_603, 0.9411765*node_603) ,
                                                    float3(0.9411765*node_603, 0.9098039*node_603, 0.5960784*node_603) , 0.0 , 0.01 ),

                                                    float3(0.40784313*node_603, 0.8156862*node_603, 0.9411765*node_603) ,
                                                    float3(0.9411765*node_603, 0.9098039*node_603, 0.81568627*node_603) , 0.0 , 0.01 ),
